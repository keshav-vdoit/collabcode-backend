...
// import { CircleCheck, CloudUpload, Copy } from "lucide-react";
...
//         JSON.stringify({ sessionId, content})
//       );
//     }
//   };
...
//         <h2 className="colored-text">Code Colab</h2>
//         <h4 className="text-xl flex items-center">
//           Share Session :
//           <button
//             className={`p-2 px-4 text-base flex items-center text-center gap-2 transition rounded text-white font-semibold m-3 ${
...
//           </button>
//         </h4>
//         <button className="p-2 px-4 text-base flex items-center text-center gap-2  transition rounded text-white font-semibold m-3 bg-primary hover:bg-text-1">
